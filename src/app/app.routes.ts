...
import { AttemptSessionComponent } from '@components/attempt-sessions/attempt-sessions.component';
...
export const routes: Routes = [
  ...
  },
  {
    ...
    component: AttemptSessionComponent,
    data: { idParam: 'examId', defaultTitle: 'Simulado ENEM', finishLabel: 'Concluir Prova' },
    canActivate: [authGuard],
  },
  {
    path: 'attempt-sessions-simulation/:sessionId',
    component: AttemptSessionComponent,
    data: { idParam: 'sessionId', defaultTitle: 'Treino Personalizado', finishLabel: 'Concluir Treino' },
    canActivate: [authGuard],
  },
  {
    path: 'attempt-sessions-avulso/:avulsoId',
    component: AttemptSessionComponent,
    data: { idParam: 'avulsoId', defaultTitle: 'Simulado Personalizado', finishLabel: 'Finalizar Treino' },
    canActivate: [authGuard],
  },
  {
